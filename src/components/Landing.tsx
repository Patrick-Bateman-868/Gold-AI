...
const translations = {
  ru: {
    ...
    heroTitle: "AI-ментор заменяет недостающий слой экспертизы",
    heroDesc: "Обеспечиваем масштабируемое и дешёвое обучение робототехнике в сельских регионах. Ваш персональный наставник 24/7.",
    cta: "Начать обучение",
